...
from core.widgets.services.weather.animation import WeatherAnimationManager
from core.widgets.services.weather.api import IconFetcher
from core.widgets.services.weather.utils import (
    ColorFetchWidget,
    copy_painter_state,
...
class HourlyDataLineWidget(QFrame):
    ...
    def update_weather(
        ...
        if self.config["weather_animation"]["enable_debug"]:
            from core.widgets.services.weather.debug import generate_debug_data
